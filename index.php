        ...
        <div class="row">
            <div class="col-md-6">
                <div class="detail-box">
                    ...
                    <p>
                        BWT allows you to bookmark your past and future reads on the internet and to attach to them tags to your so you can find them later more easily.
                        Filter your reads by date, name, tags, length... Create reading lists based on past, actual or future reads.</p>
                    <a href="">
                        Read More
                    </a>
                </div>
